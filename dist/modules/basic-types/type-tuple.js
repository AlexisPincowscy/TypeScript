...
// arrays padrão
let exeArray = [1, 'Guerra Civil', false]; // tudo certo aqui, ele aceita aquelas variações de valores, independtenda ordem
// exemplo de tupla
let exeTuple = [2, 'Cidade de Deus', true]; //aqui precisa estar na ordem certa do parâmetro, senão da erro
...
let exeTupleOption = [2, 'Cidade de Deus']; //aqui o ? deixa o valor ser o tipo ou não ter nada, caso exista a opção de não ser prenchido
